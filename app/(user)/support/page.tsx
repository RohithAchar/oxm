        ...
        <Card className="text-center shadow-lg">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-slate-600">
              Our support system is currently under construction. We're working
              hard to bring you the best customer experience!
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-600">Ticket system</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-orange-400"></div>
                <span className="text-slate-600">FAQ section</span>
              </div>
            </div>
          </CardContent>
        </Card>
