...
export const ProductForm = ({
  ...
  // Validate only fields relevant to the current step before advancing
  const stepFieldMap: Record<
    string,
    Array<keyof z.infer<typeof productFormSchema>>
  > = {
  ...
  const goNext = async () => {
    ...
    const fields = stepFieldMap[stepKey] as any;
  ...
  const draftStorageKey = useMemo(
    () => `product-form-draft:${business?.profile_id ?? "unknown"}`,
    [business?.profile_id]
  );
  ...
  useEffect(() => {
    ...
    const subscription = form.watch((values) => {
      ...
      try {
        localStorage.setItem(draftStorageKey, JSON.stringify(rest));
      } catch (_) {}
    });
      ...
      <CardContent>
        <Form {...form}>
          ...
          >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Brand is automatically set based on your business
                          name.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Select a specific sub-category after choosing the
                            main category.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                    ...
                    <div className="bg-secondary border rounded-lg p-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-sm text-secondary-foreground">
                          ...
                          <p>
                            Customers will automatically get the best price
                            based on their order quantity. Lower quantities =
                        ...
                        <FormItem>
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            <div className="space-y-1">
                              ...
                              <FormDescription>
                                Specify whether the product is active or
                                inactive.
                              </FormDescription>
                            </div>
                            <FormControl>
            ...
            {currentStep === 4 && isSampleAvailable && (
              <div className="space-y-4 lg:space-y-6">
                <div>
                  <h2 className="text-lg lg:text-xl font-semibold">
            ...
            {/* Step 2: Details - Shipping & Dropshipping */}
            {currentStep === 2 && (
              <div className="space-y-4 lg:space-y-6">
                <div>
                  <h2 className="text-lg lg:text-xl font-semibold">
            ...
            {/* Step 2: Details - Additional Details */}
            {currentStep === 2 && (
              <div className="space-y-4 lg:space-y-6">
                <div>
                  <h2 className="text-lg lg:text-xl font-semibold">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm text-blue-800">
                        ...
                        <ul className="text-xs space-y-1">
                          <li>
                            • Use descriptive keywords that customers might
                            search for
                          </li>
                          <li>
